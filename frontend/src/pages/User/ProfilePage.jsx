...
import { Box, Typography, Container, TextField, Button, Snackbar, Avatar, Grid, CircularProgress, Paper } from '@mui/material';
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={4}>
              <Box sx={{ textAlign: 'center' }}>
                <ProfileImage src={`http://localhost:8081/images/${profileImage}`} alt="Profile Image" />
                <input
                  type="file"
                  accept="image/*"
